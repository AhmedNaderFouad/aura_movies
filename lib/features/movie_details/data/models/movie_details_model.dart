...
class ProductionCountryModel extends entities.ProductionCountry {
  ProductionCountryModel({required String iso31661, required String name})
    ...
    return MovieDetailsModel(
      ...
      productionCompanies:
          (json['production_companies'] as List<dynamic>?)
              ?.map(
                (c) =>
                    ProductionCompanyModel.fromJson(c as Map<String, dynamic>),
              )
              .toList() ??
          [],
      productionCountries:
          (json['production_countries'] as List<dynamic>?)
              ?.map(
                (c) =>
                    ProductionCountryModel.fromJson(c as Map<String, dynamic>),
              )
              .toList() ??
          [],
